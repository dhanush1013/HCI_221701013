 ...
 * @author Hi
 */
public class loginpafe extends javax.swing.JFrame {

    /**
     * Creates new form loginpafe
     */
    public loginpafe() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("ANNA UNIVERSITY");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String pd = jPasswordField1.getText();
        
        if(un.equals("Dhanush") && pd.equals("dhanush123"));
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(loginpafe.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
